...
//                String strWaktu = txtwaktu.getText().toString();
                ...
                if (strTanggal != "" || strNominal != "" || strKeterangan != ""){
                    Boolean insert = db.insertCashFlow(strTanggal,userID,"in",strNominal, strKeterangan);
                    if (insert == true){
                        Toast.makeText(getApplicationContext(), "Berhasil Menambahkan Pemasukan", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(getApplicationContext(), CashFlowActivity.class));
                        finish();
                    }else{
                        Toast.makeText(getApplicationContext(), "Gagal Menambahkan Pemasukan", Toast.LENGTH_SHORT).show();
                    }
                }else{
